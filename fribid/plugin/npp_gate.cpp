...
// here the plugin creates an instance of our FriBIDPlugin object which 
                ...
                NPSavedData* saved)
{
    ...
    FriBIDPlugin * pPlugin = new FriBIDPlugin(pluginType, instance);
    if (pPlugin == NULL)
...
// here is the place to clean up and destroy the FriBIDPlugin object
NPError NPP_Destroy (NPP instance, NPSavedData** save)
{
    ...
    if (instance->pdata)
        delete (FriBIDPlugin *)instance->pdata;
...
NPError	NPP_GetValue(NPP instance, NPPVariable variable, void *value)
{
    ...
    FriBIDPlugin * plugin = (FriBIDPlugin *)instance->pdata;
    if (plugin == NULL)
    ...
    switch (variable) {
        ...
        case NPPVpluginDescriptionString:
            *((char **)value) = "FriBID (Opensource BankId implementation)";
            break;
...
NPObject *NPP_GetScriptableInstance(NPP instance)
{
    ...
    NPObject *npobj = NULL;
    FriBIDPlugin * pPlugin = (FriBIDPlugin *)instance->pdata;
    if (!pPlugin)
